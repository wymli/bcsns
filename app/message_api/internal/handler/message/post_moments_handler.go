...
func PostMomentsHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PostMomentsReq
		...
		l := message.NewPostMomentsLogic(r.Context(), ctx)
		resp, err := l.PostMoments(req)
